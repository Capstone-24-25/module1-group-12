...
# Average the ranks from t-tests and RF
...
proteins_ranked <- proteins_ranked %>% mutate(avg=(rank_s1 + rank_s2) / 2) %>% 
  arrange(avg)

# pull top significant proteins with fuzzy intersection (average of top ranks)
